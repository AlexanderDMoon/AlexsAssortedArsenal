...
{
    public class CrossbowTungsten : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Tungsten Crossbow");
            Tooltip.SetDefault("Fires Tungsten Arrows when using Wooden Arrows as ammo. \nRight-click to zoom out.");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.autoReuse = true;
            item.shootSpeed = 12f;
            item.shoot = mod.ProjectileType("ArrowTungsten");
            item.crit = 2;
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            {
                type = mod.ProjectileType("ArrowTungsten");
            }
            return true;
        }
