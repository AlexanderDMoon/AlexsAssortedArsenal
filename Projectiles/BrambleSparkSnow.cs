...
{
    public class BrambleSparkSnow : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Snow Bramble Burst");          
        }
        ...
        {
            SpawnProjectilePatternOn(projectile, ModContent.ProjectileType<BrambleSparkSnowFragment>(), 4, projectile.rotation, MathHelper.PiOver2, 8f);
