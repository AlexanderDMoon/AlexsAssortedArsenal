...
{
    public class NunchuckSlash : ModProjectile //Special thanks to DayOrk for making this code for me!
    {
        ...
        {
            DisplayName.SetDefault("Nunchuck Slash");
        }
        ...
        {
            Player p = Main.player[projectile.owner];
            var Texture = ModContent.GetTexture("AlexsAssortedArsenal/Projectiles/NunchuckSlash");
            spriteBatch.Draw(
                Texture,
