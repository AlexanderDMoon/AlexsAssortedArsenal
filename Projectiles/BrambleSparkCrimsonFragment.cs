...
{
    public class BrambleSparkCrimsonFragment : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Crimson Bramble Fragment");          
        }
        ...
        {
            Main.player[projectile.owner].AddBuff(BuffID.Regeneration, 60);
        }
