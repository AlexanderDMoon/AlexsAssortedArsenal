...
{
    public class FairiumBoltMight : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Fairium Might Bolt");
        ...
        {
            Main.player[projectile.owner].AddBuff(mod.BuffType("EnchantmentOfMight"), 180);
        }
