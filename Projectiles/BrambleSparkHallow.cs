...
{
    public class BrambleSparkHallow : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Hallow Bramble Burst");
        }
        ...
        {
            SpawnProjectilePatternOn(projectile, ModContent.ProjectileType<BrambleSparkHallowFragment>(), 2, projectile.rotation + MathHelper.PiOver2, MathHelper.Pi, 8f);

            for (int i = 0; i < 30; ++i)
            {
                Dust newDust = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, 64, 0f, 0f, 100, default, 1f)];
            ...
            for (int i = 0; i < 20; ++i)
            {
                ...
                newDust = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, 64, 0f, 0f, 100, default, 1f)];
                newDust.velocity *= 3f;
            }
