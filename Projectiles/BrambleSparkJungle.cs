...
{
    public class BrambleSparkJungle : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Jungle Bramble Burst");          
        }
        ...
        {
            SpawnProjectilePatternOn(projectile, ModContent.ProjectileType<BrambleSparkJungleFragment>(), 4, projectile.rotation, MathHelper.PiOver2, 8f);

            for (int i = 0; i < 30; ++i)
            {
                Dust newDust = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, 61, 0f, 0f, 100, default, 1f)];
            ...
            for (int i = 0; i < 20; ++i)
            {
                ...
                newDust = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, 61, 0f, 0f, 100, default, 1f)];
                newDust.velocity *= 3f;
            }
