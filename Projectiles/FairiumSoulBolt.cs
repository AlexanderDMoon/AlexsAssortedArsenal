...
{
    public class FairiumSoulBolt : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Fairium Soul Bolt");          
        }
        ...
        {
            Main.player[projectile.owner].AddBuff(mod.BuffType("EnchantmentOfSight"), 180);
